...
file = input("Enter the name of the pdf file (include '.pdf'): ")
...
if ".pdf" in file:
    ...
    # Send chunks to LLM with prompts
    ...
    print("Please enter a pdf of txt file")



## Step 3: Send text to LLM
    # include concise prompt that emphasizes length targets

## Step 4: Display output
    # display output in the terminal or in an output.txt file